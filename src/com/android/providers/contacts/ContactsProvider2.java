...
public class ContactsProvider2 extends AbstractContactsProvider
    ...
    private static final String DEFAULT_CONTACT_PREFERENCE_KEY = "DefaultSet";
    ...
    private boolean isDefaultContactRequired() {
        ...
        boolean exists = prefs.getBoolean(DEFAULT_CONTACT_PREFERENCE_KEY,
                resources.getBoolean(R.bool.preference_default_contact));
    ...
    private void addDefaultContact() {
        ...
        Cursor c = null;
        try {
            c = query(RawContacts.CONTENT_URI,
                    new String[]{RawContacts._ID},
                    RawContacts.DISPLAY_NAME_PRIMARY + "=?",
                    new String[]{defaultContactName}, null);

            if (c.getCount() > 0) {
                // TODO: Entry already exists do we need to update?
                setDefaultContactEntered();
                return;
            }
        } finally {
            if (c != null) {
    ...
    private void setDefaultContactEntered() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(getContext());
        SharedPreferences.Editor editor = prefs.edit();
        editor.putBoolean(DEFAULT_CONTACT_PREFERENCE_KEY, false);
        editor.commit();
    }
